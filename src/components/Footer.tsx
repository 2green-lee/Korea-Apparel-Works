...
export default function Footer({ onAdminClick, setCurrentSlide }: FooterProps) {
  ...
  return (
    <div className="w-full bg-transparent border-t border-neutral-200/30">
      <footer 
        id="footer" 
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10 relative z-10 flex flex-col justify-between items-stretch gap-12 select-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-span-5 space-y-4">
              <div className="flex items-center space-x-2.5">
                ...
                <span className="font-sans font-semibold tracking-widest text-[11px] text-neutral-900">
                  Korea Apparel Works
                </span>
              </div>
            ...
            {/* Links grid (7 cols) */}
            <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-6 font-mono text-[11px] text-neutral-500">
              <div>
                <span className="block text-neutral-800 uppercase tracking-wider font-bold mb-3 select-none">HOME</span>
                <ul className="space-y-2 font-light">
                  <li>
                    <button 
                      onClick={() => navigateToSection(0, "ai-dialogue-portal-container")} 
                      className="hover:text-neutral-900 cursor-pointer select-none text-left font-sans"
                    >
                      Chat
                    </button>
                  </li>
              ...
              <div>
                <span className="block text-neutral-800 uppercase tracking-wider font-bold mb-3 select-none">MANUFACTURING</span>
                <ul className="space-y-2 font-light">
                  <li>
                    <button 
                      onClick={() => navigateToSection(1)} 
                      className="hover:text-neutral-900 cursor-pointer select-none text-left"
                    >
                      Atelier Workshop
                    </button>
                  </li>
              ...
              <div>
                <span className="block text-neutral-800 uppercase tracking-wider font-bold mb-3 select-none">PRODUCT</span>
                <ul className="space-y-2 font-light font-sans">
                  ...
                  {onAdminClick && (
                    <li className="pt-2 border-t border-neutral-200/50 mt-2">
                      <button 
                        onClick={onAdminClick} 
                        className="hover:text-neutral-900 cursor-pointer select-none text-left tracking-wider text-[#8a7256] font-bold font-sans"
                      >
                        ADMIN CONSOLE
                      </button>
                    </li>
          ...
          <div className="border-t border-neutral-200/30 pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] text-neutral-500 font-mono gap-4 select-none">
            ...
            <div className="flex gap-4">
              <span className="hover:text-neutral-800 cursor-pointer">PRIVACY JOURNAL</span>
              <span>•</span>
              ...
              <span 
                ...
                className="hover:text-amber-600 text-amber-600/80 cursor-pointer font-bold"
