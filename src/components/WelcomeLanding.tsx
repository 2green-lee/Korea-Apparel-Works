...
export default function WelcomeLanding() {
  ...
  const heroImages = ['p1.jpg', 'p2.jpg', 'p3.jpg', 'p4.jpg', 'p5.jpg', 'p6.jpg', 'p7.jpg'].map(
        ...
        <section ref={samplePolicyRef} className="w-full bg-white pt-24 pb-24 px-6 border-t border-neutral-100 overflow-hidden">
          <div className={`max-w-[1000px] mx-auto w-full transition-all duration-1000 ${samplePolicyIn ? 'translate-y-0' : 'translate-y-10'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-4">
              {/* Card 1 */}
              <a href="/" id="gtm-welcome-sample-first-btn" className="gtm-conversion-btn bg-white rounded-2xl p-6 border-2 border-blue-400 shadow-md shadow-blue-900/5 relative overflow-hidden flex flex-col items-center text-center cursor-pointer hover:shadow-lg hover:-translate-y-0.5 transition-all">
              ...
              {/* Card 2 */}
              <a href="/" id="gtm-welcome-sample-size-btn" className="gtm-conversion-btn bg-white rounded-2xl p-6 border border-neutral-200 shadow-sm flex flex-col items-center text-center cursor-pointer hover:border-neutral-300 hover:shadow-lg hover:-translate-y-0.5 transition-all">
              ...
              {/* Card 3 */}
              <a href="/" id="gtm-welcome-sample-revision-btn" className="gtm-conversion-btn bg-white rounded-2xl p-6 border border-neutral-200 shadow-sm flex flex-col items-center text-center cursor-pointer hover:border-neutral-300 hover:shadow-lg hover:-translate-y-0.5 transition-all">
            ...
            {/* 3. Credit Banner */}
            <a href="/" id="gtm-welcome-sample-credit-btn" className="gtm-conversion-btn w-full bg-emerald-50 border border-emerald-100 rounded-2xl p-6 sm:p-8 mb-16 flex flex-col items-center text-center cursor-pointer hover:shadow-md transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
              <a href="/" id="gtm-welcome-sample-remake-btn" className="gtm-conversion-btn bg-neutral-50 rounded-2xl p-6 sm:p-8 flex items-start gap-4 sm:gap-5 border border-neutral-100 cursor-pointer hover:shadow-md transition-all">
              ...
              <a href="/" id="gtm-welcome-sample-refund-btn" className="gtm-conversion-btn bg-neutral-50 rounded-2xl p-6 sm:p-8 flex items-start gap-4 sm:gap-5 border border-neutral-100 cursor-pointer hover:shadow-md transition-all">
                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-blue-600 shadow-sm shrink-0 mt-1">
