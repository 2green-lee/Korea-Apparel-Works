        ...
        <section ref={samplePolicyRef} className="w-full bg-white pt-24 pb-24 px-6 border-t border-neutral-100 overflow-hidden">
          <div className={`max-w-[1000px] mx-auto w-full transition-all duration-1000 ${samplePolicyIn ? 'translate-y-0' : 'translate-y-10'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-4">
              {/* Card 1 */}
              <a href="/" id="gtm-welcome-sample-first-btn" className="gtm-conversion-btn bg-white rounded-2xl p-6 border-2 border-blue-400 shadow-md shadow-blue-900/5 relative overflow-hidden flex flex-col cursor-pointer hover:shadow-lg hover:-translate-y-0.5 transition-all">
              ...
              {/* Card 2 */}
              <a href="/" id="gtm-welcome-sample-size-btn" className="gtm-conversion-btn bg-white rounded-2xl p-6 border border-neutral-200 shadow-sm flex flex-col cursor-pointer hover:border-neutral-300 hover:shadow-lg hover:-translate-y-0.5 transition-all">
              ...
              {/* Card 3 */}
              <a href="/" id="gtm-welcome-sample-revision-btn" className="gtm-conversion-btn bg-white rounded-2xl p-6 border border-neutral-200 shadow-sm flex flex-col cursor-pointer hover:border-neutral-300 hover:shadow-lg hover:-translate-y-0.5 transition-all">
