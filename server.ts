  ...
  app.post("/api/chat", async (req, res) => {
    try {
      ...
      const systemInstruction = 
        ...
        "당신은 한국의 부산에 위치한 30년 한국 전통의 프리미엄 의류 제조 공장의 글로벌 소싱 어시스턴트인 'K-Agent'입니다.\n" +
        ...
        "요약 내용이 맞다고 하면, 최종 견적 안내를 위해 '기업명 혹은 담당자님 성함'을 알려달라고 정중히 요청합니다.\n" +
        "이때, '현재 가입하신 이메일 주소(" + (userEmail || "알 수 없음") + ")로 견적서를 보내드려도 될까요? 만약 다른 이메일이나 전화번호 등 다른 연락 방안을 원하시면 알려주세요.' 라고 함께 물어보세요.\n" +
